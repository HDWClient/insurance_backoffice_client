...
- Name: login/user-login.spec.js >> User Login Page >> renders branding and form elements
- Location: tests/login/user-login.spec.js:14:3
...
Locator: locator('.kl-brand__logo')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.kl-brand__logo')
