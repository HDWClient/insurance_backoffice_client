...
- Name: login/super-admin-login.spec.js >> Super Admin Login Page >> Forgot Password >> successful password reset shows done view
- Location: tests/login/super-admin-login.spec.js:194:5
...
- generic [ref=e4]:
  ...
  - generic [ref=e12]:
    - generic [ref=e13]:
      ...
      - textbox "One-Time Code" [active] [ref=e15]:
        - /placeholder: ••••••
        - text: "123456"
